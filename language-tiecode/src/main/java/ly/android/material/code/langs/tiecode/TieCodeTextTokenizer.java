 ...
 * @author Rose
 */
public class TieCodeTextTokenizer {
    ...
    public TieCodeTextTokenizer(CharSequence src) {
        if (src == null) {
    ...
    protected static void doStaticInit() {
        sKeywords = new String[]{
                ...
                "this", "throw", "throws", "true", "false", "null", "var", "sealed", "permits", "包名",
                "类", "变量", "常量", "方法", "属性写", "属性读", "属性", "事件", "定义事件", "结束", "为", "真", "假",
                "空", "本对象", "父对象", "如果", "则", "否则", "循环", "假如", "是", "订阅事件", "返回", "创建", "等待", "跳过循环",
                "退出循环", "整数", "文本", "小数", "单精度小数", "长整数", "逻辑型", "变形体"
        };
        Tokens[] sTokens = new Tokens[]{
                ...
                Tokens.THIS, Tokens.THROW, Tokens.THROWS, Tokens.TRUE, Tokens.FALSE, Tokens.NULL, Tokens.VAR, Tokens.SEALED, Tokens.PERMITS, Tokens.包名,
                Tokens.包名, Tokens.类, Tokens.变量, Tokens.常量, Tokens.方法, Tokens.属性写, Tokens.属性读, Tokens.属性, Tokens.事件, Tokens.定义事件, Tokens.结束,
                Tokens.为, Tokens.真, Tokens.假, Tokens.空, Tokens.本对象, Tokens.父对象, Tokens.如果, Tokens.则, Tokens.否则, Tokens.循环, Tokens.假如, Tokens.是,
                Tokens.订阅事件, Tokens.返回, Tokens.创建, Tokens.等待, Tokens.跳过循环, Tokens.退出循环, Tokens.整数, Tokens.文本, Tokens.小数, Tokens.单精度小数,
                Tokens.长整数, Tokens.逻辑型, Tokens.变形体
        };
